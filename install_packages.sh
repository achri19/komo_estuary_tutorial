...
pip install nose mpi4py triangle Pmw pymetis cmocean geopandas fiona pygeos rasterio rasterstats git+https://github.com/simard-landscape-lab/orinoco.git > /dev/null 2>&1
